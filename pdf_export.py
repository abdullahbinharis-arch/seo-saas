...
class SEOReport(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 6, _s(f"LocalRankr.io SEO Report  |  {biz}"), align="L")
        self.ln(1)
    ...
    def footer(self):
        ...
        self.set_text_color(*GRAY_TEXT)
        self.cell(0, 6, _s(f"Generated by LocalRankr.io  |  Page {self.page_no()} of {{nb}}"), align="C")
...
def _cover(pdf: SEOReport):
    ...
    pdf.cell(0, 6, "LOCALRANKR.IO", ln=True)

    # Title
    pdf.set_x(18)
    pdf.set_font("Helvetica", "B", 24)
    pdf.set_text_color(*WHITE)
    pdf.cell(0, 12, "AI-Powered Local SEO Audit Report", ln=True)
...
def _score_overview(pdf: SEOReport):
    ...
    pdf.cell(100, 7, "Overall LocalRankr Score", align="C")
    # Status
    pdf.set_font("Helvetica", "", 9)
    pdf.set_text_color(*color)
...
def _cta_page(pdf: SEOReport):
    ...
    pdf.set_font("Helvetica", "B", 10)
    pdf.set_text_color(*EMERALD)
    pdf.cell(0, 7, "LOCALRANKR.IO", align="C", ln=True)

    # Headline
    pdf.set_font("Helvetica", "B", 18)
    pdf.set_text_color(*NAVY)
    pdf.cell(0, 10, "Track your progress at localrankr.io", align="C", ln=True)
    ...
    pdf.set_font("Helvetica", "", 8)
    pdf.set_text_color(*GRAY_TEXT)
    pdf.cell(0, 5, "localrankr.io", align="C")
